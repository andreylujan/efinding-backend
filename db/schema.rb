...
ActiveRecord::Schema.define(version: 20170920160146) do
  ...
  create_table "app_menu_items", force: :cascade do |t|
    ...
    t.boolean  "filter_creator",       default: false, null: false
    t.boolean  "filter_assigned_user", default: false, null: false
    t.datetime "created_at",                           null: false
    t.datetime "updated_at",                           null: false
    t.index ["organization_id"], name: "index_app_menu_items_on_organization_id", using: :btree
  end
  ...
  create_table "organizations", force: :cascade do |t|
    ...
    t.text     "time_zone",              default: "Chile/Continental", null: false
  ...
  create_table "reports", id: :uuid, default: nil, force: :cascade do |t|
    ...
    t.boolean  "auto_assigned_on_creation", default: true,  null: false
    t.index ["assigned_user_id"], name: "index_reports_on_assigned_user_id", using: :btree
    t.index ["auto_assigned_on_creation"], name: "index_reports_on_auto_assigned_on_creation", using: :btree
  ...
  add_foreign_key "pdf_templates", "report_types"
  add_foreign_key "pdfs", "pdf_templates"
